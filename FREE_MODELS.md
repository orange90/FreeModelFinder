...
> 最近目录审计：**2026-09-20（Asia/Shanghai）** · **72** 个免费模型入口 · **9/10** 个 Provider 正常。
...
与 2026-09-19 相比，成功比较的 9 个 Provider 模型清单没有变化。
...
| `openrouter:deepseek/deepseek-v4-flash-0731:free`               | DeepSeek: DeepSeek V4 Flash 0731 (free)  |         1M |
